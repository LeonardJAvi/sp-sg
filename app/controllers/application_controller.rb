...
class ApplicationController < ActionController::Base
  ...
  def devise_new
    devise_parameter_sanitizer.permit(:sign_up, keys: [:name, :email, :password, :password_confirmation,  :phone, :address, :last_name, :identification, :birthdate])
    devise_parameter_sanitizer.permit(:account_update, keys: [:name, :email, :password, :password_confirmation,  :phone, :address, :last_name, :identification, :birthdate])
  end
