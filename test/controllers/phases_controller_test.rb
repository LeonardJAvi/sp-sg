...
class PhasesControllerTest < ActionController::TestCase
  ...
  test "should create phase" do
    assert_difference('Phase.count') do
      post :create, phase: { description: @phase.description, name: @phase.name, project_id: @phase.project_id }
    end
  ...
  test "should update phase" do
    patch :update, id: @phase, phase: { description: @phase.description, name: @phase.name, project_id: @phase.project_id }
    assert_redirected_to phase_path(assigns(:phase))
  end
